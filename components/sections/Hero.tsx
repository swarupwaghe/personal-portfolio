...
import { Spatial3DOrb } from '@/components/ui/Spatial3DOrb';
  ...
  return (
    <section id="home" className="section hero-section">
      <div className="container">
        <SpatialCard className="hero-card-frame" depth={14}>
          <StaggerContainer>
            {/* Futuristic Spatial HUD Corner Crosshairs elevated in 3D */}
            ...
            {/* Interactive 3D Holographic Cyber Core Orb Widget */}
