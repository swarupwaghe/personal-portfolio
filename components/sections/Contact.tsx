        ...
        <div className="contact-grid">
          ...
          <FadeIn className="contact-left-panel">
            ...
            <div className="contact-cards-stack">
              {/* Phone Option */}
              <SpatialCard depth={6} className="contact-option-spatial-wrapper">
                <a 
                ...
                >
                  <div className="contact-option-left">
                    <div className="contact-option-icon depth-layer-2">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                      </svg>
                    </div>
                    <div>
                      <div className="contact-option-title depth-layer-1">Contact me</div>
                      <div className="contact-option-detail depth-layer-2">+91 9321281463</div>
                    </div>
                  </div>
                  <div className="contact-option-arrow depth-layer-3">↗</div>
                </a>
              </SpatialCard>
              ...
              <SpatialCard depth={6} className="contact-option-spatial-wrapper">
                ...
                >
                  <div className="contact-option-left">
                    ...
                    <div>
                      <div className="contact-option-title depth-layer-1">Email</div>
                      <div className="contact-option-detail depth-layer-2">{personalInfo.email}</div>
                    </div>
                  </div>
                  <div className="contact-option-arrow depth-layer-3">↗</div>
                </a>
              ...
              <SpatialCard depth={6} className="contact-option-spatial-wrapper">
                ...
                >
                  <div className="contact-option-left">
                    ...
                    <div>
                      <div className="contact-option-title depth-layer-1">Location</div>
                      <div className="contact-option-detail depth-layer-2">{personalInfo.location}</div>
                    </div>
                  </div>
                  <div className="contact-option-arrow depth-layer-3">↗</div>
                </a>
          ...
          {/* Right Panel Form Card wrapped in SpatialCard */}
          <FadeIn>
            <SpatialCard className="contact-form-card" depth={10}>
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div className="contact-field-group depth-layer-1">
                    <input
                      type="text"
                  ...
                  <button type="submit" className="contact-submit-btn depth-layer-2">
                    Submit
                  </button>
                </form>
              )}
